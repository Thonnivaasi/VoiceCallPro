...
public class MainActivity extends AppCompatActivity {
    ...
    private final ServiceConnection serviceConn = new ServiceConnection() {
        public void onServiceConnected(ComponentName n, IBinder b) {
            callService = ((CallService.LocalBinder) b).getService(); serviceBound = true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindViews(); setupBluetooth(); requestPerms(); setupListeners();
...
((TextView)findViewById(R.id.tvWifiBtLabel)).setTextColor(getColor(R.color.text_secondary));
    ...
    private void setupListeners() {
        switchWifiBt.setOnCheckedChangeListener((b, checked) -> {
            ((TextView)findViewById(R.id.tvWifiLabel)).setTextColor(getColor(checked ? R.color.text_secondary : R.color.accent));
            ((TextView)findViewById(R.id.tvWifiBtLabel)).setTextColor(getColor(checked ? R.color.accent : R.color.text_secondary));
            setStatus(checked ? "Mode: WiFi + BT Audio" : "Mode: WiFi Only");
        });
        switchBtMic.setOnCheckedChangeListener((b, checked) -> {
            ...
            if (checked) { loadPairedDevices(); setStatus("Mode: BT + BT Mic"); }
